...
import CheckoutForm from "./components/CheckoutForm"; // <--- Formulario de pago integrado con Stripe
...
/* consts para Stripe APIs */

const stripe = loadStripe(
  "pk_test_51TAgYpIxcOa0nOdxO87GsA0hhDJRAidYG6Nz4VkbuWfIROCbGAayHuQddAiIYteVn2qPkOpbzYlYn5wqXgLvlVRr00vQ60BaLt",
);
...
const AppContent = () => {
      ...
      const fetchAves = async () => {
        try {
          const res = await axios.get(
            "https://cunaalada-kitw.onrender.com/api/aves",
          );
    ...
    return (
      <div className="flex flex-col">
        <div className="relative min-h-[90vh] flex items-center overflow-hidden">
          ...
          <div
            className="bg-orb bottom-[-200px] left-[-100px] bg-blue-100"
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-8">
              <div className="lg:w-1/2 text-center lg:text-left reveal">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 rounded-full border border-emerald-100 text-emerald-700 font-bold text-xs uppercase tracking-widest mb-8">
                  <Sparkles size={14} className="animate-pulse" /> Criadero
                  Profesional • Campeche
                </div>
                ...
                <p className="text-lg md:text-xl text-slate-500 max-w-xl mx-auto lg:mx-0 leading-relaxed mb-10 font-medium">
                  ...
                  Garantizamos salud, dócilidad y el mejor comienzo para tu
                  compañero.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                  <Link
                    to="/aves"
                    className="btn-action bg-slate-900 text-white px-10 py-5 rounded-2xl font-bold flex items-center justify-center gap-3 no-underline shadow-2xl"
                  >
                    Ver Colección <ArrowRight size={20} />
                  </Link>
                  <Link
                    to="/tienda"
                    className="btn-action bg-white text-slate-700 border border-slate-200 px-10 py-5 rounded-2xl font-bold flex items-center justify-center gap-3 no-underline glass"
                  >
                ...
                <div className="mt-12 flex flex-wrap justify-center lg:justify-start gap-8 opacity-60">
                  <div className="flex items-center gap-2 font-bold text-xs uppercase">
                    <Zap size={16} /> Entrega Inmediata
                  </div>
                  <div className="flex items-center gap-2 font-bold text-xs uppercase">
                    <ShieldCheck size={16} /> Salud Certificada
                  </div>
                </div>
              </div>

              <div
                className="lg:w-1/2 relative reveal"
                  ...
                  <div className="relative aspect-square rounded-[50px] overflow-hidden group">
                    ...
                    <div className="absolute bottom-8 left-8 right-8 p-6 glass rounded-3xl border border-white/40 shadow-2xl">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-extrabold text-xl m-0 text-slate-800">
                            Crianza con Amor
                          </p>
                          <p className="text-xs font-bold text-emerald-600 m-0 uppercase tracking-widest">
                            Campeche, México
                          </p>
                        </div>
                      </div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div
        className={`fixed top-0 right-0 h-full w-[85%] max-w-sm glass-dark z-[110] transform transition-transform duration-500 ease-out lg:hidden shadow-2xl flex flex-col p-8 justify-between ${menuMovilAbierto ? "translate-x-0" : "translate-x-full"}`}
      >
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
              <div className="lg:col-span-5 space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <h3 className="text-3xl font-black m-0 tracking-tighter text-white">
                    CUNA<span className="text-emerald-500">ALADA</span>
                  </h3>
                </div>
                <p className="text-slate-400 text-base leading-relaxed max-w-sm">
                  Dedicados a la crianza responsable y amorosa. Creamos vínculos
                  para toda la vida entre aves y familias.
                </p>
