    ...
    <div className="container mx-auto px-8 md:px-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
        <div className="lg:col-span-5 space-y-6">
          ...
          <p className="text-slate-400 text-base leading-relaxed max-w-sm">
            Dedicados a la crianza responsable y amorosa. Creamos vínculos para
            toda la vida entre aves y familias.
          </p>
      ...
      <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] font-bold tracking-widest text-slate-500 uppercase">
        ...
        <div className="flex items-center gap-1.5 opacity-60">
          Creado con{" "}
          <Heart size={10} className="text-emerald-500 fill-emerald-500" /> por
          DevJP
        </div>
      </div>
    </div>
