...
import { 
  ...
  Sparkles, ArrowRight, Heart, Instagram, Facebook, Zap, Ticket, LogOut, User
} from 'lucide-react';
        ...
        <div>
           ...
           <div className="flex flex-col gap-5">
              ...
              {[
                ...
                { name: 'Tienda', to: '/tienda', icon: <ShoppingBag size={22}/> },
                { name: 'Sorteos', to: '/sorteos', icon: <Ticket size={22}/> },
                { name: 'Academia', to: '/cuidados', icon: <BookOpen size={22}/> }
              ].map((item, i) => (
                <Link 
                  key={i} 
                  to={item.to} 
